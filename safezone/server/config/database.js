  ...
  try {
    ...
    db.exec(`
      ...
      CREATE TABLE IF NOT EXISTS dbt2 (
        ...
        FOREIGN KEY (user_token) REFERENCES dbt1(user_token) ON DELETE CASCADE
      );
      ...
      CREATE TABLE IF NOT EXISTS dbt4 (
        ...
        FOREIGN KEY (user_token) REFERENCES dbt1(user_token) ON DELETE SET NULL,
        FOREIGN KEY (farm_token) REFERENCES dbt2(farm_token) ON DELETE SET NULL
      );
      ...
      CREATE TABLE IF NOT EXISTS dbt8 (
        ...
        receiver TEXT,
        message_type TEXT,
        FOREIGN KEY (receiver) REFERENCES dbt1(user_token) ON DELETE CASCADE,
      ...
      CREATE INDEX IF NOT EXISTS idx_dbt2_farmer ON dbt2(user_token);
      CREATE INDEX IF NOT EXISTS idx_dbt3_farmer ON dbt3(user_token);
      CREATE INDEX IF NOT EXISTS idx_dbt4_farmer ON dbt4(user_token);
    ...
    // Add missing columns to dbt2 (farms)
    const dbt2Columns = db.pragma('table_info(dbt2)');
